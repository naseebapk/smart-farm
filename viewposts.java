    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AsyncTask asyncTask=new AsyncTask() {
            ...
            protected Object doInBackground(Object[] objects) {
                ...
                Request request=new Request.Builder().url("http://192.168.43.79:8000/methods/android/").build();
            ...
            protected void onPostExecute(Object o) {
                try {
                    ...
                    ListAdapter lis=new SimpleAdapter(viewposts.this,al,R.layout.post,new String[]{"title","description"},new int[]{R.id.tit,R.id.des});
